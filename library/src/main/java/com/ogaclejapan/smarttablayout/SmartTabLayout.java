...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public void setCustomTabView(int layoutResId, int textViewId) {
        Log.e("A", "setCustomTabView");
        tabProvider = new SimpleTabProvider(getContext(), layoutResId, textViewId, tabStrip, viewPager, onTabClickListener);
    }
...
//            textView.setBackgroundResource(outValue.resourceId);
    ...
    private static class SimpleTabProvider implements TabProvider {
        ...
        private SmartTabStrip smartTabStrip;
        private ViewPager viewPager;
        private OnTabClickListener onTabClickListener;
        private Context context;
        private TextView tabTitleView = null;

        private SimpleTabProvider(Context context, int layoutResId, int textViewId, SmartTabStrip tabStrip, ViewPager viewPager, OnTabClickListener onTabClickListener) {
            inflater = LayoutInflater.from(context);
            tabViewLayoutId = layoutResId;
            tabViewTextViewId = textViewId;
            this.smartTabStrip = tabStrip;
            this.viewPager = viewPager;
