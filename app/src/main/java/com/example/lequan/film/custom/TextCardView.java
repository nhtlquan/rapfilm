...
import com.example.lequan.film.model.ActionLog;
import com.example.lequan.film.model.Category;
import com.example.lequan.film.model.Episode;
import com.example.lequan.film.model.Favourite;
        ...
        if (card instanceof ActionLog) {
            ...
            if (actionLog.getTitle().equals("Đăng xuất")) {
                if (TextUtils.isEmpty(actionLog.getLink())) {
                    ...
                    imgPlay.setVisibility(8);
                    Glide.with(getContext()).load(actionLog.getLink()).into(imgAvatar);
                }
